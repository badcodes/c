...
#include "less.h"
	...
	// #define BLACK _BLACK
	// #define LIGHTGRAY _WHITE
	// #define RED _RED
	// #define YELLOW _YELLOW
	// #define GREEN _GREEN
	// #define LIGHTBLUE _LIGHTBLUE
	// #define BLINK 0xF
...
get_term()
{
	...
	#else
		_getvideoconfig(&_video);
		sc_height = _video.numtextrows;
		sc_width  = _video.numtextcols;
		directvideo = 0;
	#endif
	if (sc_width != 80)
		directvideo = 0;
